...
// of the three largest integers in the input array. Note that the function should
// return duplicate integers if necessary; for example, it should return [10,10,12]
